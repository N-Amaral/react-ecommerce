...
const Subscribe = () => {
  ...
  return (
    <Box width="80%" margin="80px auto" textAlign="center">
      ...
      <Typography>And receive the latest news on our deals!</Typography>
      <Box p="2px 4px" m="15px auto" display="flex" alignItems="center" width="75%" backgroundColor="#F2F2F2">
        ...
        <Typography sx={{ p: "10px", fontWeight: "bold", "&:hover": { cursor: "pointer", color: "red" } }}>Subscribe</Typography>
      </Box>
    </Box>
  );
};
